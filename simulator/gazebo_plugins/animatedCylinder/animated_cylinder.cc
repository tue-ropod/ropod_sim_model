...
class AnimatedCylinder : public ModelPlugin
  {
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
      ...
      this->model = _parent;
        ...
        key->Translation(ignition::math::Vector3d(-3.0, 6.6, 0));
...
//         key->Rotation(ignition::math::Quaterniond(0, 0, 1.5707));
        key->Translation(ignition::math::Vector3d(-6.5, 7.3, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
...
//         key->Rotation(ignition::math::Quaterniond(0, 0, 1.5707));
  ...
  GZ_REGISTER_MODEL_PLUGIN(AnimatedCylinder)
