...
// Constructor
CustomGazeboRosLaser::CustomGazeboRosLaser()
{
  this->seed = 0;
}
...
// Load the controller
void CustomGazeboRosLaser::Load(sensors::SensorPtr _parent, sdf::ElementPtr _sdf)
{
  // load plugin
...
# endif
  ...
  if (!this->parent_ray_sensor_)
    gzthrow("CustomGazeboRosLaser controller requires a Ray Sensor as its parent");
  ...
  this->deferred_load_thread_ = std::thread(
    std::bind(&CustomGazeboRosLaser::LoadThread, this));

}

// Load the controller
void CustomGazeboRosLaser::LoadThread()
{
  ...
  if (this->topic_name_ != "")
  {
    ros::AdvertiseOptions ao =
      ...
      this->topic_name_, 1,
      boost::bind(&CustomGazeboRosLaser::LaserConnect, this),
      boost::bind(&CustomGazeboRosLaser::LaserDisconnect, this),
      ros::VoidPtr(), NULL);
...
// Increment count
void CustomGazeboRosLaser::LaserConnect()
{
...
# endif
                                    &CustomGazeboRosLaser::OnScan, this);
}

// Decrement count
void CustomGazeboRosLaser::LaserDisconnect()
{
  this->laser_connect_count_--;
...
void CustomGazeboRosLaser::OnScan(ConstLaserScanStampedPtr &_msg)
{
